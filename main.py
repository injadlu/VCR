...
def run_training_free(cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights):
    ...
    acc = cls_acc(training_free_logits, val_labels)
...
def run_training_need(cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights, clip_model, train_loader_F):
...
def main():
    ...
    val_features, val_labels = pre_load_features(cfg, "val")

    # Pre-load test features
    print("\nLoading visual features and labels from test set.")
    test_features, test_labels = pre_load_features(cfg, "test")

    # ------------------------------------------ Training-free ------------------------------------------
    run_training_free(cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights)

    # ------------------------------------------ Training-need ------------------------------------------
    run_training_need(cfg, cache_keys, cache_values, val_features, val_labels, test_features, test_labels, clip_weights, clip_model, train_loader_F)
